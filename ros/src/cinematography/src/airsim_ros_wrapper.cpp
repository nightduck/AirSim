...
void AirsimROSWrapper::create_ros_pubs_from_settings_json()
{
    ...
    origin_geo_point_pub_ = nh_private_.advertise<cinematography::GPSYaw>("origin_geo_point", 10);
    ...
    for (const auto& curr_vehicle_elem : AirSimSettings::singleton().vehicles)
    {
        ...
        multirotor_ros.vel_cmd_body_frame_sub = nh_private_.subscribe<cinematography::VelCmd>(curr_vehicle_name + "/vel_cmd_body_frame", 1,
            boost::bind(&AirsimROSWrapper::vel_cmd_body_frame_cb, this, _1, multirotor_ros.vehicle_name)); // todo ros::TransportHints().tcpNoDelay();
        multirotor_ros.vel_cmd_world_frame_sub = nh_private_.subscribe<cinematography::VelCmd>(curr_vehicle_name + "/vel_cmd_world_frame", 1,
            boost::bind(&AirsimROSWrapper::vel_cmd_world_frame_cb, this, _1, multirotor_ros.vehicle_name));

        multirotor_ros.takeoff_srvr = nh_private_.advertiseService<cinematography::Takeoff::Request, cinematography::Takeoff::Response>(curr_vehicle_name + "/takeoff",
            boost::bind(&AirsimROSWrapper::takeoff_srv_cb, this, _1, _2, multirotor_ros.vehicle_name) );
        multirotor_ros.land_srvr = nh_private_.advertiseService<cinematography::Land::Request, cinematography::Land::Response>(curr_vehicle_name + "/land",
...
bool AirsimROSWrapper::takeoff_srv_cb(cinematography::Takeoff::Request& request, cinematography::Takeoff::Response& response, const std::string& vehicle_name)
{
...
bool AirsimROSWrapper::takeoff_group_srv_cb(cinematography::TakeoffGroup::Request& request, cinematography::TakeoffGroup::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::takeoff_all_srv_cb(cinematography::Takeoff::Request& request, cinematography::Takeoff::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::land_srv_cb(cinematography::Land::Request& request, cinematography::Land::Response& response, const std::string& vehicle_name)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::land_group_srv_cb(cinematography::LandGroup::Request& request, cinematography::LandGroup::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::land_all_srv_cb(cinematography::Land::Request& request, cinematography::Land::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::reset_srv_cb(cinematography::Reset::Request& request, cinematography::Reset::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
// void AirsimROSWrapper::vel_cmd_body_frame_cb(const cinematography::VelCmd& msg, const std::string& vehicle_name)
void AirsimROSWrapper::vel_cmd_body_frame_cb(const cinematography::VelCmd::ConstPtr& msg, const std::string& vehicle_name)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_group_body_frame_cb(const cinematography::VelCmdGroup& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
// void AirsimROSWrapper::vel_cmd_all_body_frame_cb(const cinematography::VelCmd::ConstPtr& msg)
void AirsimROSWrapper::vel_cmd_all_body_frame_cb(const cinematography::VelCmd& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_world_frame_cb(const cinematography::VelCmd::ConstPtr& msg, const std::string& vehicle_name)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_group_world_frame_cb(const cinematography::VelCmdGroup& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_all_world_frame_cb(const cinematography::VelCmd& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::gimbal_angle_quat_cmd_cb(const cinematography::GimbalAngleQuatCmd& gimbal_angle_quat_cmd_msg)
{
...
void AirsimROSWrapper::gimbal_angle_euler_cmd_cb(const cinematography::GimbalAngleEulerCmd& gimbal_angle_euler_cmd_msg)
{
    try
    {
        tf2::Quaternion quat_control_cmd;
...
cinematography::GPSYaw AirsimROSWrapper::get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const
{
    cinematography::GPSYaw gps_msg;
