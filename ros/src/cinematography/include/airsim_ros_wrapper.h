...
#include <cinematography/GimbalAngleEulerCmd.h>
#include <cinematography/GimbalAngleQuatCmd.h>
#include <cinematography/GPSYaw.h>
#include <cinematography/Land.h>
#include <cinematography/LandGroup.h>
#include <cinematography/Reset.h>
#include <cinematography/Takeoff.h>
#include <cinematography/TakeoffGroup.h>
#include <cinematography/VelCmd.h>
#include <cinematography/VelCmdGroup.h>
#include <chrono>
...
private:
    ...
    void vel_cmd_world_frame_cb(const cinematography::VelCmd::ConstPtr& msg, const std::string& vehicle_name);
    void vel_cmd_body_frame_cb(const cinematography::VelCmd::ConstPtr& msg, const std::string& vehicle_name);

    void vel_cmd_group_body_frame_cb(const cinematography::VelCmdGroup& msg);
    void vel_cmd_group_world_frame_cb(const cinematography::VelCmdGroup& msg);

    void vel_cmd_all_world_frame_cb(const cinematography::VelCmd& msg);
    void vel_cmd_all_body_frame_cb(const cinematography::VelCmd& msg);

    // void vel_cmd_body_frame_cb(const cinematography::VelCmd& msg, const std::string& vehicle_name);
    void gimbal_angle_quat_cmd_cb(const cinematography::GimbalAngleQuatCmd& gimbal_angle_quat_cmd_msg);
    void gimbal_angle_euler_cmd_cb(const cinematography::GimbalAngleEulerCmd& gimbal_angle_euler_cmd_msg);

    // void set_zero_vel_cmd();

    /// ROS service callbacks
    bool takeoff_srv_cb(cinematography::Takeoff::Request& request, cinematography::Takeoff::Response& response, const std::string& vehicle_name);
    bool takeoff_group_srv_cb(cinematography::TakeoffGroup::Request& request, cinematography::TakeoffGroup::Response& response);
    bool takeoff_all_srv_cb(cinematography::Takeoff::Request& request, cinematography::Takeoff::Response& response);
    bool land_srv_cb(cinematography::Land::Request& request, cinematography::Land::Response& response, const std::string& vehicle_name);
    bool land_group_srv_cb(cinematography::LandGroup::Request& request, cinematography::LandGroup::Response& response);
    bool land_all_srv_cb(cinematography::Land::Request& request, cinematography::Land::Response& response);
    bool reset_srv_cb(cinematography::Reset::Request& request, cinematography::Reset::Response& response);
    ...
    cinematography::GPSYaw get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const;
...
private:
    ...
    cinematography::GPSYaw origin_geo_point_msg_; // todo duplicate
