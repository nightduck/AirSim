...
#include <cinematography/SetLocalPosition.h>
#include <cinematography/SetGPSPosition.h>
...
public:
    ...
    bool local_position_goal_srv_cb(cinematography::SetLocalPosition::Request& request, cinematography::SetLocalPosition::Response& response);
    bool local_position_goal_srv_override_cb(cinematography::SetLocalPosition::Request& request, cinematography::SetLocalPosition::Response& response);
    bool gps_goal_srv_cb(cinematography::SetGPSPosition::Request& request, cinematography::SetGPSPosition::Response& response);
    bool gps_goal_srv_override_cb(cinematography::SetGPSPosition::Request& request, cinematography::SetGPSPosition::Response& response);

    // ROS subscriber callbacks
    void airsim_odom_cb(const nav_msgs::Odometry& odom_msg);
    void home_geopoint_cb(const cinematography::GPSYaw& gps_msg);
...
private:
    ...
    bool has_home_geo_;
    cinematography::GPSYaw gps_home_msg_;

    nav_msgs::Odometry curr_odom_;
    cinematography::VelCmd vel_cmd_;
    bool reached_goal_;
    bool has_goal_;
    bool has_odom_;
    bool got_goal_once_;
