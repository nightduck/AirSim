...
AirsimROSWrapper::AirsimROSWrapper(const rclcpp::Node::SharedPtr& nh, const rclcpp::Node::SharedPtr& nh_private, const std::string & host_ip) : 
    nh_(nh), 
...
geometry_msgs::msg::Pose AirsimROSWrapper::pose()
{
...
void AirsimROSWrapper::create_ros_pubs_from_settings_json()
{
    ...
    origin_geo_point_pub_ = nh_private_.advertise<cinematography_msgs::msg::GPSYaw>("origin_geo_point", 10);       
    ...
    for (const auto& curr_vehicle_elem : AirSimSettings::singleton().vehicles)
    {
        ...
        multirotor_ros.odom_local_ned_pub = nh_private_.advertise<nav_msgs::msg::Odometry>(curr_vehicle_name + "/odom_local_ned", 10);
        multirotor_ros.global_gps_pub = nh_private_.advertise<sensor_msgs::msg::NavSatFix>(curr_vehicle_name + "/global_gps", 10);
        ...
        multirotor_ros.vel_cmd_body_frame_sub = nh_private_.subscribe<cinematography_msgs::msg::VelCmd>(curr_vehicle_name + "/vel_cmd_body_frame", 1, 
            boost::bind(&AirsimROSWrapper::vel_cmd_body_frame_cb, this, _1, multirotor_ros.vehicle_name)); // todo ros::TransportHints().tcpNoDelay();
        multirotor_ros.vel_cmd_world_frame_sub = nh_private_.subscribe<cinematography_msgs::msg::VelCmd>(curr_vehicle_name + "/vel_cmd_world_frame", 1, 
            boost::bind(&AirsimROSWrapper::vel_cmd_world_frame_cb, this, _1, multirotor_ros.vehicle_name));

        multirotor_ros.takeoff_srvr = nh_private_.advertiseService<cinematography_msgs::srv::Takeoff::Request, cinematography_msgs::srv::Takeoff::Response>(curr_vehicle_name + "/takeoff", 
            boost::bind(&AirsimROSWrapper::takeoff_srv_cb, this, _1, _2, multirotor_ros.vehicle_name) );
        multirotor_ros.land_srvr = nh_private_.advertiseService<cinematography_msgs::srv::Land::Request, cinematography_msgs::srv::Land::Response>(curr_vehicle_name + "/land", 
        ...
        for (auto& curr_camera_elem : vehicle_setting->cameras)
        {
            ...
            for (const auto& curr_capture_elem : camera_setting.capture_settings)
            {
                ...
                if ( !(std::isnan(capture_setting.fov_degrees)) )
                {
                    ...
                    cam_info_pub_vec_.push_back(nh_private_.advertise<sensor_msgs::msg::CameraInfo> (curr_vehicle_name + "/" + curr_camera_name + "/" + image_type_int_to_string_map_.at(capture_setting.image_type) + "/camera_info", 10));
        ...
        for (auto& curr_sensor_map : vehicle_setting->sensors)
        {
            ...
            switch (sensor_setting->sensor_type)
            {
                ...
                case SensorBase::SensorType::Imu:
                {
                    ...
                    imu_pub_vec_.push_back(nh_private_.advertise<sensor_msgs::msg::Imu> (curr_vehicle_name + "/imu/" + sensor_name, 10));
                    break;
                }
...
bool AirsimROSWrapper::takeoff_srv_cb(cinematography_msgs::srv::Takeoff::Request& request, cinematography_msgs::srv::Takeoff::Response& response, const std::string& vehicle_name)
{
...
bool AirsimROSWrapper::takeoff_group_srv_cb(cinematography_msgs::srv::TakeoffGroup::Request& request, cinematography_msgs::srv::TakeoffGroup::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::takeoff_all_srv_cb(cinematography_msgs::srv::Takeoff::Request& request, cinematography_msgs::srv::Takeoff::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::land_srv_cb(cinematography_msgs::srv::Land::Request& request, cinematography_msgs::srv::Land::Response& response, const std::string& vehicle_name)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::land_group_srv_cb(cinematography_msgs::srv::LandGroup::Request& request, cinematography_msgs::srv::LandGroup::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::land_all_srv_cb(cinematography_msgs::srv::Land::Request& request, cinematography_msgs::srv::Land::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
bool AirsimROSWrapper::reset_srv_cb(cinematography_msgs::srv::Reset::Request& request, cinematography_msgs::srv::Reset::Response& response)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
// void AirsimROSWrapper::vel_cmd_body_frame_cb(const cinematography_msgs::msg::VelCmd& msg, const std::string& vehicle_name)
void AirsimROSWrapper::vel_cmd_body_frame_cb(const cinematography_msgs::msg::VelCmd::ConstPtr& msg, const std::string& vehicle_name)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_group_body_frame_cb(const cinematography_msgs::msg::VelCmdGroup& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
// void AirsimROSWrapper::vel_cmd_all_body_frame_cb(const cinematography_msgs::msg::VelCmd::ConstPtr& msg)
void AirsimROSWrapper::vel_cmd_all_body_frame_cb(const cinematography_msgs::msg::VelCmd& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_world_frame_cb(const cinematography_msgs::msg::VelCmd::ConstPtr& msg, const std::string& vehicle_name)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_group_world_frame_cb(const cinematography_msgs::msg::VelCmdGroup& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::vel_cmd_all_world_frame_cb(const cinematography_msgs::msg::VelCmd& msg)
{
    std::lock_guard<std::recursive_mutex> guard(drone_control_mutex_);
...
void AirsimROSWrapper::gimbal_angle_quat_cmd_cb(const cinematography_msgs::msg::GimbalAngleQuatCmd& gimbal_angle_quat_cmd_msg)
{
...
void AirsimROSWrapper::gimbal_angle_euler_cmd_cb(const cinematography_msgs::msg::GimbalAngleEulerCmd& gimbal_angle_euler_cmd_msg)
{
    try
    {
        tf2::Quaternion quat_control_cmd;
...
cinematography_msgs::msg::GPSYaw AirsimROSWrapper::get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const
{
    cinematography_msgs::msg::GPSYaw gps_msg;
